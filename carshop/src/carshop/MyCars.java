 ...
 * @author ahmed
 */
public class MyCars extends javax.swing.JFrame {

    /**
     * Creates new form MyCars
     */
    int userId;
    String userName;
    public MyCars(int id,String uName) {
        this.userId = id;        
        this.userName = uName;
    ...
    private void initComponents() {
        ...
        carstab = new javax.swing.JTable();
        ...
        carstab.setAutoCreateRowSorter(true);
        carstab.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        TableRowSorter<TableModel> sorter = new TableRowSorter<>(carstab.getModel());
     ...
     // Custom comparator for the "Id" column (index 0)
        ...
        carstab.setRowSorter(sorter);
        jScrollPane1.setViewportView(carstab);
        ...
        Return.setBackground(new java.awt.Color(33, 126, 225));
        Return.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 14)); // NOI18N
        Return.setForeground(new java.awt.Color(255, 255, 255));
        Return.setText("Return the Car");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGap(315, 315, 315)
                .addComponent(Return, javax.swing.GroupLayout.DEFAULT_SIZE, 307, Short.MAX_VALUE)
                .addGap(357, 357, 357))
        );
    ...
    public void fetchMyCars(){
        String url = "jdbc:mysql://localhost:3306/carshop"; // DB URL
        String dbUser = "root"; // DB username
        String dbPassword = ""; // DB password
        String query = "SELECT id,model,age,prix,marque,is_rented FROM cars where rented_by = ?"; // SQL query
        ...
        try (Connection connection = DriverManager.getConnection(url, dbUser, dbPassword);
            ...
            // Get the table model
            DefaultTableModel model = (DefaultTableModel) carstab.getModel();
            ...
            while (resultSet.next()) {
                ...
                model.addRow(new Object[]{carId ,modelValue, marque,age, prix});
            }
    ...
    private void mycarsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mycarsActionPerformed
            ClientDashboard dashboard = new ClientDashboard(String.valueOf(userId));
    ...
    private void ReturnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ReturnActionPerformed
        int selectedRow = carstab.getSelectedRow();

        // Check if exactly one row is selected
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(this, "Please select a car to Return.", "No Selection", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        String idString = (String) carstab.getValueAt(selectedRow, 0); // Assuming column 0 is the ID
        int carId;
        try {
        ...
        // Replace with the logic to fetch the logged-in user's ID

        // Confirm rental action
        int confirm = JOptionPane.showConfirmDialog(this, "Are you sure you want to Return this car?", "Confirm Rental", JOptionPane.YES_NO_OPTION);
        ...
        String dbUser = "root"; // DB username
        String dbPassword = ""; // DB password
        String query = "UPDATE cars SET is_rented = 0, rented_by = Null WHERE id = ?";
        ...
        try (Connection connection = DriverManager.getConnection(url, dbUser, dbPassword);
            ...
            if (rowsAffected > 0) {
                ...
                fetchMyCars(); // Refresh the car list to update the table
            } else {
    ...
    private javax.swing.JTable carstab;
